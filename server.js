...
app.get('/car', car.get)
app.post('/car', auth.checkIfInRole([0]), car.post)
app.put('/car', auth.checkIfInRole([0]), car.put)
app.delete('/car', auth.checkIfInRole([0]), car.delete)

app.get('/rent', rent.get)
app.post('/rent', auth.checkIfInRole([0, 1]), rent.post)
app.put('/rent', auth.checkIfInRole([0, 1]), rent.put)
app.delete('/rent', auth.checkIfInRole([0, 1]), rent.delete)
